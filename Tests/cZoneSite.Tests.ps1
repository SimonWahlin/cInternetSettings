$Module = "$PSScriptRoot\..\DSCResources\SimonW_cZoneSite\SimonW_cZoneSite.psm1"
Remove-Module -Name SimonW_cZoneSite -Force -ErrorAction SilentlyContinue
Import-Module -Name $Module -Force -ErrorAction Stop

InModuleScope SimonW_cZoneSite {
    
    Describe 'SimonW_cZoneSite' {
